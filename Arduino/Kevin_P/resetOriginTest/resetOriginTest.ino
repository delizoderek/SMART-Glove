...
const int IMUPin1 = A4;
const int IMUPin2 = A5;
...
void loop() {
  ...
  } else {//(digitalRead(PinButton2) == LOW)
...
///reset Accelerometer to origin
void resetAccelToOrigin() {
...
void resetGyroToOrigin() {
  ...
  while(Wire.available() < 6);
  gX = Wire.read() << 0b0000000;
  gY = Wire.read() << 0b0000000;
  gZ = Wire.read() << 0b0000000;
